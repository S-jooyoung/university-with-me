          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <div className="mx-auto max-w-md px-4 text-center sm:max-w-2xl sm:px-6 lg:flex lg:items-center lg:px-0 lg:text-left">
              <div className="lg:py-24">
                ...
                <button type="submit" className="block w-4/12 rounded-md bg-violet-500 py-3 px-4 font-medium text-white shadow hover:bg-violet-800 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 focus:ring-offset-gray-900">
                  시작하기
                </button>
              </div>
            </div>
